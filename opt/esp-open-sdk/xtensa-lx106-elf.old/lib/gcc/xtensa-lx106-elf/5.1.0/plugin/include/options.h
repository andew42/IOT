...
enum opt_code
{
  ...
  OPT_mconst16 = 1136,                       /* -mconst16 */
  OPT_mforce_no_pic = 1137,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1138, */              /* -mfused-madd */
  OPT_mlongcalls = 1139,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1140,            /* -mserialize-volatile */
  OPT_mtarget_align = 1141,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1142,         /* -mtext-section-literals */
  OPT_n = 1143,                              /* -n */
  OPT_no_canonical_prefixes = 1144,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1145,              /* -no-integrated-cpp */
  ...
  OPT_pie = 1158,                            /* -pie */
  OPT_pipe = 1159,                           /* -pipe */
  OPT_print_file_name_ = 1160,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1161,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1162,          /* -print-multi-directory */
  OPT_print_multi_lib = 1163,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1164,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1165,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1166,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1167,               /* -print-prog-name= */
  OPT_print_search_dirs = 1168,              /* -print-search-dirs */
  OPT_print_sysroot = 1169,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1170,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1171,                          /* -quiet */
  OPT_r = 1172,                              /* -r */
  OPT_rdynamic = 1173,                       /* -rdynamic */
  OPT_remap = 1174,                          /* -remap */
  OPT_s = 1175,                              /* -s */
  OPT_s_bc_abi = 1176,                       /* -s-bc-abi */
  OPT_save_temps = 1177,                     /* -save-temps */
  OPT_save_temps_ = 1178,                    /* -save-temps= */
  OPT_shared = 1179,                         /* -shared */
  OPT_shared_libgcc = 1180,                  /* -shared-libgcc */
  /* OPT_specs = 1181, */                    /* -specs */
  OPT_specs_ = 1182,                         /* -specs= */
  OPT_static = 1183,                         /* -static */
  OPT_static_libasan = 1184,                 /* -static-libasan */
  OPT_static_libgcc = 1185,                  /* -static-libgcc */
  OPT_static_libgcj = 1186,                  /* -static-libgcj */
  OPT_static_libgfortran = 1187,             /* -static-libgfortran */
  OPT_static_libgo = 1188,                   /* -static-libgo */
  OPT_static_liblsan = 1189,                 /* -static-liblsan */
  OPT_static_libmpx = 1190,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1191,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1192,               /* -static-libstdc++ */
  OPT_static_libtsan = 1193,                 /* -static-libtsan */
  OPT_static_libubsan = 1194,                /* -static-libubsan */
  /* OPT_std_c__03 = 1195, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1196, */                /* -std=c++0x */
  OPT_std_c__11 = 1197,                      /* -std=c++11 */
  OPT_std_c__14 = 1198,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1199, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1200, */                /* -std=c++1y */
  OPT_std_c__1z = 1201,                      /* -std=c++1z */
  OPT_std_c__98 = 1202,                      /* -std=c++98 */
  OPT_std_c11 = 1203,                        /* -std=c11 */
  /* OPT_std_c1x = 1204, */                  /* -std=c1x */
  /* OPT_std_c89 = 1205, */                  /* -std=c89 */
  OPT_std_c90 = 1206,                        /* -std=c90 */
  OPT_std_c99 = 1207,                        /* -std=c99 */
  /* OPT_std_c9x = 1208, */                  /* -std=c9x */
  OPT_std_f2003 = 1209,                      /* -std=f2003 */
  OPT_std_f2008 = 1210,                      /* -std=f2008 */
  OPT_std_f2008ts = 1211,                    /* -std=f2008ts */
  OPT_std_f95 = 1212,                        /* -std=f95 */
  OPT_std_gnu = 1213,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1214, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1215, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1216,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1217,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1218, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1219, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1220,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1221,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1222,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1223, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1224, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1225,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1226,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1227, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1228, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1229,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1230, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1231, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1232, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1233,                     /* -std=legacy */
  OPT_symbolic = 1234,                       /* -symbolic */
  OPT_t = 1235,                              /* -t */
  OPT_time = 1236,                           /* -time */
  OPT_time_ = 1237,                          /* -time= */
  OPT_traditional = 1238,                    /* -traditional */
  OPT_traditional_cpp = 1239,                /* -traditional-cpp */
  OPT_trigraphs = 1240,                      /* -trigraphs */
  OPT_u = 1241,                              /* -u */
  OPT_undef = 1242,                          /* -undef */
  OPT_v = 1243,                              /* -v */
  OPT_version = 1244,                        /* -version */
  OPT_w = 1245,                              /* -w */
  OPT_wrapper = 1246,                        /* -wrapper */
  OPT_x = 1247,                              /* -x */
  OPT_z = 1248,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
